...
func WithIDs(ids ...string) Filter {
	return func() bson.E {
...
func WithCreatedAtAfter(created_at time.Time) Filter {
	return func() bson.E {
		return bson.E{
			Key:   "created_at",
...
func WithCreatedAtBefore(created_at time.Time) Filter {
	return func() bson.E {
		return bson.E{
			Key:   "created_at",
...
func WithUpdatedAtAfter(updated_at time.Time) Filter {
	return func() bson.E {
		return bson.E{
			Key:   "updated_at",
...
func WithUpdatedAtBefore(updated_at time.Time) Filter {
	return func() bson.E {
		return bson.E{
			Key:   "updated_at",
